...
@SpringBootTest(webEnvironment = SpringBootTest.WebEnvironment.RANDOM_PORT) // JPA 기능까지 한번에 테스트할때 사용하는 어노테이션
...
//    @WithMockUser(roles="USER")
    public void Posts_등록된다() throws Exception {
        ...
        ResponseEntity<Object> responseEntity = restTemplate.postForEntity(
                url,requestDto,Object.class);

        //then
        assertThat(responseEntity.getStatusCode()).isEqualTo(HttpStatus.OK);
        //assertThat(responseEntity.getBody()).isGreaterThan(OL);
